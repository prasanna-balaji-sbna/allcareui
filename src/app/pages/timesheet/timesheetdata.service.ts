...
import { gettimesheet } from './timesheet.model';
...
export class timesheetdataservice extends Subject<DataStateChangeEventArgs>{
    childdata: any = [];
    timelst: any = [];
    ...
    getList(state?: gettimesheet): Observable<DataStateChangeEventArgs> {
        ...
        return this.http.post<any>("api/Timesheet/FilterTimeSheetItem", state)
            .map(
                (response: any) => (<any>{
